...
async function run() {
    try {
        ...
        const menuCollection = client.db("FoodOwala").collection("menu");
        const cartsCollection = client.db("FoodOwala").collection("carts");
        const userCollection = client.db("FoodOwala").collection("users");
        const paymentCollection = client.db("FoodOwala").collection("payments");
        const reviewsCollection = client.db("FoodOwala").collection("reviews")
        const teamCollection = client.db("FoodOwala").collection("team")
...
app.listen(port, () => {
    console.log(` Restaurant is sitting port on ${port}`);
})
